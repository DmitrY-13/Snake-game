...
private:
	inline bool isWallCollision(Point snakeHeadCoordinates);
	inline std::string getScoreString(int score);
	void drawFrame(sf::Color background, std::vector<Point> snakeCoordinates, Point appleCoordinates, sf::Text scoreText);
};
